...
import io.mangoodev.agroapp.application.service.PresupuestoService;
...
/**
 * REST controller for managing {@link io.mangoodev.agroapp.application.domain.Presupuesto}.
 */
@RestController
@RequestMapping("/api")
